...
touch p p1440
rclone --config rclone.conf lsf D1:Archive/Unsorted/ | grep 1440p.mp4 >> p1440
...
rclone --config rclone.conf lsf D1:Archive/Unsorted/ | grep XXX >> p
rclone --config rclone.conf lsf D1:Archive/Unsorted/ | grep PRT >> p
